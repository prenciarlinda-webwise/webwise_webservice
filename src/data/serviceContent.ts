...
export const seoServiceContent: ServiceContent = {
  ...
  industries: {
    ...
    list: [
      ...
      { name: 'Landscapers', description: 'SEO for landscapers and lawn care companies, seasonal keyword strategies from spring cleanup to snow removal.', link: '/local-seo/landscaping' },
      { name: 'Locksmiths', description: 'Locksmith SEO that captures 24/7 emergency lockout calls and builds long-term organic visibility.', link: '/local-seo/locksmiths' },
      { name: 'Cleaning Services', description: 'Residential and commercial cleaning service SEO to rank for "house cleaning near me" and recurring contracts.', link: '/local-seo/cleaning' },
...
export const localSeoContent: ServiceContent = {
  ...
  packages: {
    question: 'Which Local SEO Package Is Right for My Business?',
    intro: 'Choose the plan that matches your current visibility, competition level, and growth goals. Every plan includes a first-month audit and a measurable 3-month roadmap.',
    tiers: [
      {
        ...
        bestFor: 'New businesses or those with little/no existing SEO',
      },
      {
        ...
        features: [
          ...
          '5 local citations + 1 backlink per month',
          '2 blog posts/month (800+ words, fully optimized)',
          'On-page SEO for all service & location pages',
        ...
        bestFor: 'Established businesses ready to outrank local competitors',
      },
      {
        ...
        features: [
          ...
          '10+ citations & backlinks per month',
          '4 blog posts/month (1,000+ words, schema-optimized)',
          ...
          'Aggressive backlink outreach campaign',
          'Dedicated account manager',
        ],
        bestFor: 'Competitive markets where you need to dominate, not just rank',
      },
    ],
    pricingLink: '/pricing',
  },
